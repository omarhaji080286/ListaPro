...
public class RetrofitHelper {
    ...
    //TODO Version web
    private final static String webVersion = "listapro_11";//update 10/04/2020

    //TODO Lista LOCAL
    //private static final String HOST = "http://192.168.43.211/lista_local/"+webVersion+"/webservices/";

    //TODO Lista LWS_PRE_PROD
    private final static String HOST = "http://lista-courses.com/lista_pre_prod/"+webVersion+"/webservices/";
